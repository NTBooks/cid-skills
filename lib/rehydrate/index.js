...
async function runRehydrate(contractAddress, dataDir, options = {}) {
  ...
  console.log('Fetching UpdateMapping events...');
  console.log(`Contract: ${contractAddress}`);
  console.log(`Original starting block: ${startingBlock}`);
  ...
  const courier = createCourier(chain, DUMMY_PRIVATE_KEY, null, config);
  let history;
  try {
