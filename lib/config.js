...
function getNetworkSettingsPath() {
  return path.join(getDataDir(), 'network.json');
}

function getVersion() {
  // When packaged with pkg, package.json is an asset next to the exe
