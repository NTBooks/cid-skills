...
function getCliHelpText() {
  return [
    ...
    `  ${c.cyan}rehydrate${c.reset} ${c.gray}<contract> [folder] [--full]${c.reset}  Fetch MappingUpdated events, download IPFS files`,
    ...
    '',
    `${c.bold}Options for rehydrate:${c.reset}`,
    `  ${c.yellow}--full${c.reset}   Also download nested CIDs from parsed JSON into files/assets/`,
    '',
